...
$no_surat=$_GET['n'];
$kode=$_GET['g'];
$query="SELECT * FROM `tb_sidang` JOIN tb_guru ON tb_sidang.kode_guru=tb_guru.kode_guru JOIN tb_nilai ON tb_sidang.no_surat_sidang=tb_nilai.no_surat_sidang JOIN tb_siswa ON tb_nilai.nis=tb_siswa.nis JOIN tb_jurusan ON tb_siswa.kode_jurusan=tb_jurusan.kode_jurusan WHERE tb_sidang.no_surat_sidang='$no_surat' AND tb_sidang.kode_guru='$kode'";
...
<center><br>
	<table height="50">
		<tr  align="center">
			<td>
				<b><u>SURAT TUGAS MENGUJI LAPORAN PRAKERIN</u></b>
			</td>
		</tr>
		<tr  align="center">
			<td>
...
<table style="margin-top: 30px; margin-left: -40px;">
	...
	<tr>
		<td colspan="3" style="padding-top: 10px; padding-bottom: 10px;">Untuk Melaksanakan Pengujian Laporan siswa PRAKERIN. Adapun daftar peserta sidang yang ada pada lampiran.<br><br>Demikian surat tugas ini dibuat, agar dilaksanakan dengan penuh tanggung jawab. Atas perhatian dan kerjasamanya, saya ucapkan terima kasih.</td>
	</tr>
</table>
<table align="right" style="margin-top: 10px;">
	...
	<table height="50">
		<tr  align="center">
			<td>
				<b><u>LAMPIRAN SURAT TUGAS MENGUJI LAPORAN SISWA PRAKERIN</u></b>
			</td>
		</tr>
		<tr  align="center">
			<td>
	...
	<?php 
	$query1="SELECT * FROM `tb_sidang` JOIN tb_guru ON tb_sidang.kode_guru=tb_guru.kode_guru JOIN tb_nilai ON tb_sidang.no_surat_sidang=tb_nilai.no_surat_sidang JOIN tb_siswa ON tb_nilai.nis=tb_siswa.nis JOIN tb_jurusan ON tb_siswa.kode_jurusan=tb_jurusan.kode_jurusan WHERE tb_sidang.no_surat_sidang='$no_surat' AND tb_sidang.kode_guru='$kode'";
	$res1=mysql_query($query1) or die(mysql_error());
	?>
	<table style="margin-top: 20px; margin-left: -40px;">
		<tr>
			<td>
				Berikut adalah nama siswa yang harus diuji dan diberi nilai
			</td>
		</tr>
	</table>
