        ...
        <span class="span">Tampilkan Data Berdasarkan</span><br>
          ...
          <button class="btn btn-primary btn-sm" id="button" data-toggle="dropdown">Jurusan</button>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="data_pemohon.php?j=all&k=all">Tampil Semua</a>
              <?php 
              $query="SELECT * FROM tb_jurusan";
              $result=mysql_query($query) or die(mysql_error());
              while ($hasil=mysql_fetch_array($result)) { ?>
                <a class="dropdown-item" href="data_list_siswa.php?j=<?php echo $hasil['kode_jurusan'];?>&k=all"><?php echo $hasil['nama_jurusan'];?></a>
              <?php
              }
              ?>
          ...
          <button class="btn btn-primary btn-sm" id="button" data-toggle="dropdown">Kelas</button>
            <div class="dropdown-menu">
              ...
              $result=mysql_query($query) or die(mysql_error());
              while ($hasil=mysql_fetch_array($result)) { ?>
                <a class="dropdown-item" href="data_list_siswa.php?j=all&k=<?php echo $hasil['kelas'];?>"><?php echo $hasil['kelas'];?></a>
              <?php
              }
              ?>
